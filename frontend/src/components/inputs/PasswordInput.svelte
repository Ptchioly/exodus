...
<style lang="postcss">
  ...
  .pwd-input {
    @apply flex content-center self-center placeholder-gray-500 pl-1 border-2 mt-5 py-2 rounded-lg w-full text-lg dark:bg-dark dark:border-darker border-gray-200 dark:text-gray-300 text-gray-700;
  }
